  ...
  },
  {
    ...
    slides: [
      ...
      },
      {
        ...
        type: 'image',
        src: getAssetPath('images/portfolio/Military/CGBL_RC_3_zps56866326.png'),
        title: 'CGBL RC 3',
        description: 'Coast Guard insignia design with official styling.',
        software: 'Adobe Illustrator, Photoshop',
        thumbnail: getAssetPath('images/portfolio/Military/CGBL_RC_3_zps56866326.png')
      },
      {
        id: 'military-cgbl-rc-7',
        type: 'image',
        src: getAssetPath('images/portfolio/Military/CGBL_RC_7_zps5a59e045.png'),
        title: 'CGBL RC 7',
        description: 'Coast Guard insignia variation with detailed elements.',
        software: 'Adobe Illustrator, Photoshop',
        thumbnail: getAssetPath('images/portfolio/Military/CGBL_RC_7_zps5a59e045.png')
      },
      {
      ...
      },
      {
        id: 'military-mcpo',
        type: 'image',
        src: getAssetPath('images/portfolio/Military/MCPO.png'),
        title: 'MCPO Insignia',
        description: 'Master Chief Petty Officer insignia design.',
        software: 'Adobe Illustrator',
        thumbnail: getAssetPath('images/portfolio/Military/MCPO.png')
      },
      {
      ...
      },
      {
        id: 'military-scpo',
        type: 'image',
        src: getAssetPath('images/portfolio/Military/SCPO.png'),
        title: 'SCPO Insignia',
        description: 'Senior Chief Petty Officer insignia design.',
        software: 'Adobe Illustrator',
        thumbnail: getAssetPath('images/portfolio/Military/SCPO.png')
      }
    ]
  },
  {
    ...
    slides: [
      {
        id: 'web-ic-launcher',
        type: 'image',
        src: getAssetPath('images/portfolio/Web/ic_launcher.png'),
        title: 'App Icon Launcher',
        description: 'Mobile app launcher icon design with modern styling.',
        software: 'Figma, Adobe Illustrator',
        thumbnail: getAssetPath('images/portfolio/Web/ic_launcher.png')
      },
      {
        id: 'web-launcher-icon',
        type: 'image',
        src: getAssetPath('images/portfolio/Web/launcher_icon4_sm.png'),
        title: 'Launcher Icon Small',
        description: 'Small launcher icon design for web applications.',
        software: 'Figma, Adobe Illustrator',
        thumbnail: getAssetPath('images/portfolio/Web/launcher_icon4_sm.png')
      }
    ]
  },
  {
